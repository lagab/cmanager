...
class ContactGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Contact entity")
        ...
        .repeat(2) {
            ...
            .post("/api/contacts")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "email":"SAMPLE_TEXT", "gender":null, "fullName":"SAMPLE_TEXT", "lastName":"SAMPLE_TEXT", "firstName":"SAMPLE_TEXT", "attributes":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
