...
class AttachmentGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Attachment entity")
        ...
        .repeat(2) {
            ...
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "contentType":"SAMPLE_TEXT", "filename":"SAMPLE_TEXT", "path":"SAMPLE_TEXT", "downloads":"0", "size":"0", "createdAt":"2020-01-01T00:00:00.000Z", "createdBy":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
